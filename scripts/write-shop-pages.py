...
index_body = f"""        <div class="crumb"><a href="/">Home</a> / Shop</div>
        <h2>Shop</h2>
        <p>Starter store for One Piece TCG playmats, dice, sleeves, and fan-made custom leaders. Orders go through Discord until a checkout is wired up. Fan merch only — not official Bandai product, not tournament-legal unless you use licensed sleeves/dice at events that allow them.</p>
        <div class="shop-grid">
